...
export class SanitaryPermitPrintService {
  constructor(private dateService: DateService) {}

  async print(data: ISanitaryPermit) {
    // TODO: uncomment this function as a whole
    // const element = data;
    // try {
    //   const secondPdfBytes = await fetch('/assets/pdfs/sanitary_permit_form.pdf').then(res =>
    //     res.arrayBuffer()
    //   );
    //   const pdfDoc = await PDFDocument.load(secondPdfBytes);
    //   pdfDoc.setTitle('Sanitary Permit');
    ...
    //   form.getTextField('SP_NO').setText(cutAreaNo);
    ...
    //   form.getTextField('NO').setText(addressNo.toUpperCase());
    ...
    //     isShallowWellInst,
    //     isDeepWellInst,
    //     isCityOrMunicipalWaterSystemInst,
    //     isOthersWaterSupplyInst,
    //   } = element;
    //   if (isShallowWellInst) {
    //     form.getCheckBox('SHALLOW_WELL').check();
    //   }
    //   if (isDeepWellInst) {
    //     form.getCheckBox('DEEP_WELL').check();
    //   }
    //   if (isCityOrMunicipalWaterSystemInst) {
    //     form.getCheckBox('CITY_MUN_WATER_SYSTEM').check();
    //   }
    //   if (isOthersWaterSupplyInst) {
    //     form.getCheckBox('OTHER_WATER_SUPPLY').check();
    //   }
    //   const {
    //     isWasteWaterSysOfD,
    //     isImhoffThankSysOfD,
    //     isSanintarySewerConditionSysOfD,
    //     isSubSurfaceFilterSysOfD,
    //     isSurfaceDrainageSysOfD,
    //     isSreetCanalSysOfD,
    //     isWaterCourse,
    //     isOtherSystemOfD,
    //   } = element;
    //   if (isWasteWaterSysOfD) {
    //     form.getCheckBox('WASTE_WTER_TREATMENT').check();
    //   }
    //   if (isImhoffThankSysOfD) {
    //     form.getCheckBox('IMHOFF_TANK').check();
    //   }
    //   if (isSanintarySewerConditionSysOfD) {
    //     form.getCheckBox('SANITARY_SEWER_CONNECTION').check();
    //   }
    //   if (isSubSurfaceFilterSysOfD) {
    //     form.getCheckBox('SUB_SURFACE_SAND_FILTER').check();
    //   }
    //   if (isSurfaceDrainageSysOfD) {
    //     form.getCheckBox('SURFACE_DRAINAGE').check();
    //   }
    //   if (isSreetCanalSysOfD) {
    //     form.getCheckBox('STREET_CANAL').check();
    //   }
    //   if (isWaterCourse) {
    //     form.getCheckBox('WATER_COURSE').check();
    //   }
    //   if (isOtherSystemOfD) {
    //     form.getCheckBox('OTHER_SYSTEM_DISPOSAL').check();
    //   }
  ...
  async printList() {
    ...
    // this.ELEMENT_DATA.forEach((element: ISanitaryPermit) => {
    //   compiledData.push([
    ...
    //     { text: element.building.taxDecNo },

...
export class PlumbingPermitPrintService {
  constructor(private dateService: DateService) {}

  async print(data: IPlumbingPermit) {
    // const element = data;
    // try {
    //   const secondPdfBytes = await fetch('/assets/pdfs/plumbing_permit_form.pdf').then(res =>
    //     res.arrayBuffer()
    //   );
    //   const pdfDoc = await PDFDocument.load(secondPdfBytes);
    //   pdfDoc.setTitle('Plumbing Permit');
    ...
    //   form.getTextField('PP_NO').setText(cutAreaNo);
  ...
  async printList() {
    ...
    // this.ELEMENT_DATA.forEach((element: IPlumbingPermit) => {
    //   compiledData.push([

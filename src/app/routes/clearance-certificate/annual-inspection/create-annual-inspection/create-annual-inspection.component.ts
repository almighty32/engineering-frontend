...
@Component({
  selector: 'app-create-annual-inspection',
  templateUrl: './create-annual-inspection.component.html',
  styleUrls: ['./create-annual-inspection.component.scss'],
})
export class CreateAnnualInspectionComponent implements OnInit {

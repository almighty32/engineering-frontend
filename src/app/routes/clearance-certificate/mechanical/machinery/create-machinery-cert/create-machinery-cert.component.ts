...
@Component({
  selector: 'app-create-machinery-cert',
  templateUrl: './create-machinery-cert.component.html',
  styleUrls: ['./create-machinery-cert.component.scss'],
})
export class CreateMachineryCertComponent implements OnInit {

...
@Component({
  selector: 'app-create-escalator-cert',
  templateUrl: './create-escalator-cert.component.html',
  styleUrls: ['./create-escalator-cert.component.scss'],
})
export class CreateEscalatorCertComponent implements OnInit {

...
@Component({
  selector: 'app-create-gas-pipe-burner-cert',
  templateUrl: './create-gas-pipe-burner-cert.component.html',
  styleUrls: ['./create-gas-pipe-burner-cert.component.scss'],
})
export class CreateGasPipeBurnerCertComponent implements OnInit {
